    ...
    <MarketingLayout>
      ...
      <section className="flex flex-col items-center justify-center gap-4 max-w-md mx-auto">
        ...
        <div className="w-full max-w-xs">
          <select
            className="w-full h-10 rounded-lg border border-neutral-300 shadow-xs bg-background px-3 py-2 text-sm ring-offset-background transition focus:border-neutral-500 focus:ring-2 focus:ring-emerald-600 focus:ring-offset-1 focus:outline-0"
